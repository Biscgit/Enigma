...
- Remove TextField commented code soon
- Add comments
- Add tests
...
class Lampfield extends StatefulWidget {
  late LampfieldState lampfieldState; //Access the state from outside if needed (i.e. for sendTextInputToLampfield)
...
class LampfieldState extends State<Lampfield> {
  ...
  String lightUpLetter(String characterToLightUp) {
    ...
    return characterToLightUp; //might be necessary? might also not be necessary, who knows
  }
        ...
        body: Column(
            ...
            children: [
              Row(
                ...
                children: [ //Initialises 26 textboxes that look like lamps in a QWERTZ keyboard layout. Globalkey-index is spot_in_alphabet - 1.
              ...
              //SizedBox( //ONLY FOR MANUAL TEXT INPUTS!!!!! TO BE REMOVED LATER!!
                //width: 300,
                //child: TextField(
                  //onChanged: (String value) {
                    ...
                    //}
                    //else {
                      //lightUpLetter("."); //Special characters dont light up anything; as it should be.
                    //}
                  //}
                //)
              //)
